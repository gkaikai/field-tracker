...
///   Fence 30001~30002, User/Org 30010~30012, Visit 30020~30023,
///   Message 30030, Expense 30031,
///   Attendance 40001~40006, Common 50000~50001
...
class ErrorCode {
  ...
  // ──────────────────────────────────────────────
  // Fence 模块（30001-30002）
  // ──────────────────────────────────────────────

  /// 30001 - 围栏不存在
  static const int fenceNotFound = 30001;
  /// 30002 - 操作过于频繁
  static const int fenceRateLimited = 30002;

  // ──────────────────────────────────────────────
  // User/Org 模块（30010-30012）
  // ──────────────────────────────────────────────

  /// 30010 - 该手机号已存在
  static const int userExists = 30010;
  /// 30011 - 数据库查询失败
  static const int dbError = 30011;
  /// 30012 - 部门不存在
  static const int deptNotFound = 30012;

  // ──────────────────────────────────────────────
  // Visit 模块（30020-30023）
  // ──────────────────────────────────────────────

  /// 30020 - 拜访记录不存在
  static const int visitNotFound = 30020;
  /// 30021 - 已签到或已完成
  static const int visitAlreadyCheckin = 30021;
  /// 30022 - 拜访已完成或已取消
  static const int visitCompleted = 30022;
  /// 30023 - 未在拜访中
  static const int visitNotInProgress = 30023;
  ...
  /// 30030 - 消息不存在
  static const int messageNotFound = 30030;
  ...
  /// 30031 - 报销记录不存在
  static const int expenseNotFound = 30031;
  ...
  /// 40006 - 考勤规则不存在
  static const int attendRuleNotFound = 40006;
  ...
  /// Location(20001-20006), Fence(30001-30002), User/Org(30010-30012),
  /// Visit(30020-30023), Message(30030), Expense(30031),
  /// Attendance(40001-40006), Common(50000-50001)
  static bool isBusinessError(int code) {
    return (code >= 10001 && code <= 10020) ||
        (code >= 20001 && code <= 20006) ||
        (code >= 30001 && code <= 30002) ||
        (code >= 30010 && code <= 30012) ||
        (code >= 30020 && code <= 30023) ||
        code == 30030 || code == 30031 ||
        (code >= 40001 && code <= 40006) ||
