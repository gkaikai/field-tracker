...
class _PhotoGalleryPageState extends State<PhotoGalleryPage> {
  ...
  Future<void> _load() async {
    ...
    } catch (e) { debugPrint('加载照片列表失败: $e'); if (mounted) { setState(() => _loading = false); ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('加载失败'), backgroundColor: Colors.red)); } }
  }
